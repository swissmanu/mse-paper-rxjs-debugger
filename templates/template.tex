...
\usepackage{./templates/tikz/tikzit}
...
\lstdefinelanguage{Typescript}{
	keywords={typeof, new, true, false, catch, function, return, null, catch, switch, for, var, const, let, if, in, while, do, else, case, break},
...
$endif$
$if(acmConference)$
\acmConference[$acmConference.short$]{$acmConference.name$}{$acmConference.date$}{$acmConference.venue$}
$endif$
$if(acmBooktitle)$
...
% \begin{acks}
% 	We want to thank the engineers who participated in our usability test.
% \end{acks}

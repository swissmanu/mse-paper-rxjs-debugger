...
2. A refined architecture for RxJS RP debuggers leveraging on the *Chrome DevTools Protocol*[^3] (CDP) for message-based communication between individual system components.
